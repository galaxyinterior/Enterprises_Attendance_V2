...
class _EditEmployeeScreenState extends State<EditEmployeeScreen> {
  ...
  Future<void> _captureMultiAngleStepFace() async {
    ...
    try {
      ...
      String contextName = 'EDIT_ENROLLMENT_STEP_${_multiAngleStep + 1}';
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: _isCapturingFace
                      ? null
                      : (isEnrolled ? _resetGuidedEnrollment : _captureMultiAngleStepFace),
                ),
              ),
              if (!isEnrolled) ...[
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    onPressed: _isCapturingFace ? null : _captureGuidedStepFace,
                  ),
                ),
              ],
            ],
